				...
				for(int x = 0;x<getMyMaze().getMaxX()+1;x++)
				{
					for (int y = 0; y < getMyMaze().getMaxY()+1; y++)
					{
						...
						if(getMyMaze().getCellValue(x, y, levelSelected)==0)
						{
							...
							bg.dispose();
							if((getMyMaze().getCellValue(x, y, levelSelected+1)==0)&&(levelSelected<=getMyMaze().getMaxZ()))
							{
